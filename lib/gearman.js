...
Gearman.prototype.Connection.prototype.close = function() {
    if (this.socket) {
        try {
            syslog.debug({action: 'gearman.connection.close', host: this.host, socket: this.socket });
            if (this.socket typeof function) {
                this.socket.on('close', function() {
                    // get rid of this when happy with a, if (this.gearman.debug)
                    syslog.debug({action: 'gearman.connection.close', host: this.host});

...
if (syslogConsole) {
    console = syslogConsole.init('KnoxedUp');
}
...
function Gearman(host, port, debug){
    console.log({action: 'gearman.lib', host: host, port: port, debug: debug});
    Stream.call(this);
    ...
    if (Array.isArray(host)) {
        ...
        if (cluster.isWorker) {
            ...
            console.log({action: 'gearman.lib.host.modulo', host: settings});
        } else {
            settings = host[Math.floor(Math.random() * host.length)];
            console.log({action: 'gearman.lib.host.random', host: settings});
        }
    ...
    console.log({action: 'gearman.lib.host', host: this.host});
    this.init();
}

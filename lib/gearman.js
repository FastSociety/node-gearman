...
Gearman.prototype.Worker.prototype.getHandle = function(){
    return this.handle;
};
...
Gearman.prototype.Job.prototype.onTimeout = function(){
    syslog.warn({action: 'gearman.Job.onTimeout'});
...
Gearman.prototype.Job.prototype.fail = function(oError) {
    syslog.error({action: 'gearman.Job.fail', alreadyAborted: this.aborted, name: this.name, unique: this.uniq, payload: this.payload});
    if(!this.aborted){
        if (!oError) {
